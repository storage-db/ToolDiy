![logo](https://github.com/eunomia-bpf/wasm-bpf/tree/main/docs/logo.png)
...
See the [main.rs](https://github.com/eunomia-bpf/wasm-bpf/tree/main/runtime/cmd/src/main.rs) for an example of how to use the `wasm-bpf-rs` library.
